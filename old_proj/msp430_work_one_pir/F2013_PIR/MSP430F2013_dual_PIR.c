  ...
  switch(selectADC)
  {
    ...
    case 4:
      ...
      else
      {
        ...
        eDGEdET[0] = ((aDCtEMP[0]*14+aDCtEMP[2]*36+aDCtEMP[1]*25)/75);
        eDGEdET[1] = ((aDCtEMP[1]*14+aDCtEMP[3]*36+aDCtEMP[2]*25)/75);
        eDGEdET[2] = ((aDCtEMP[2]*14+aDCtEMP[4]*36+aDCtEMP[3]*25)/75); 
        eDGErESULT = (eDGEdET[0]+eDGEdET[2])-(2*eDGEdET[1]);
        eDGEsLOPE  = (eDGEdET[2]-eDGEdET[0])/2;
        */
        aDCtEMP[6] = aDCtEMP[5];
        aDCtEMP[5] = aDCtEMP[4];
        aDCtEMP[4] = aDCtEMP[3];
        ...
        /*
        eDGErESULT = (aDCtEMP[0]+aDCtEMP[2])-(2*aDCtEMP[1]);
        eDGEsLOPE  = (aDCtEMP[2]-aDCtEMP[0]);
        */
        //}
        if ((eDGEsLOPE==0))
        {
          ...
          //eDGEaDCrEF=(eDGEaDCrEF+eDGEaDCdIF)/2; 
          eDGEaDCrEF=3;
          if (eDGEaDCrEF<=3) eDGEaDCrEF=3;//2

          //if ((eDGEaDCdIF>1)&&(eDGEcOUNT>0)&&(eDGEcOUNT<eDGEcOUNTlIMIT))
